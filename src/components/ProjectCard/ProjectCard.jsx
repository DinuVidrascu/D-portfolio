  ...
  return (
    <article className="projects__card">
      <div className="projects__image">
        <img src={img} alt={title} className="projects__img" loading="lazy" />
        <a href={projectLink} target='_blank' rel='noopener noreferrer' className="projects__button button" aria-label={`View ${title} project`}>
